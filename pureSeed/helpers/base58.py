...
# 
# 
# this file was found from the monero python library 
# https://raw.githubusercontent.com/monero-ecosystem/monero-python/master/monero/base58.py
# for use in the pureSeed implementation 
